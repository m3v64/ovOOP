...
public class TravelTo {
    ...
    private static final int[][] DISTANCES = {
            // Dryard, TimerGulch, Brittle, StaglenHold, EldYard, Trasin, SwiftLec,
            // LironGrale, Ghostle, Pearllows, Irehole, Lighthgro, Stormwall, Linere
    ...
    public TravelTo(String origin, String destination) {
        ...
        if (this.distance == 0) {
            System.out.println("Error: No direct route between " + origin + " and " + destination);
            System.exit(0);
        }
    }
